...
('a1b2c3d4-0000-4000-8000-000000000704', '660e8400-e29b-41d4-a716-446655440016', 'switch文でcaseを抜けずに次のcaseへ処理が進むことを何と呼ぶ？(Java 14以前の場合)', '{"A": "fall-through", "B": "break-out", "C": "short-circuit", "D": "override"}', 'A', 'SINGLE_CHOICE'),
...
('a1b2c3d4-0000-4000-8000-000000000803', '660e8400-e29b-41d4-a716-446655440017', 'ディレクトリを作成するLinuxコマンドは？', '{"A": "mkdir", "B": "makedir", "C": "touch", "D": "cp"}', 'A', 'SINGLE_CHOICE'),
...
('a1b2c3d4-0000-4000-8000-000000000813', '660e8400-e29b-41d4-a716-446655440022', 'ウォーターフォールモデルの特徴として正しいものは？', '{"A": "各工程を並行して進める", "B": "各工程を順番に完了させる", "C": "コードを書きながら設計する", "D": "テストを最初に行う"}', 'B', 'SINGLE_CHOICE'),
('a1b2c3d4-0000-4000-8000-000000000814', '660e8400-e29b-41d4-a716-446655440022', 'アジャイル開発の特徴として正しいものは？', '{"A": "長期的な計画を重視", "B": "反復的な開発", "C": "変更を避ける", "D": "ドキュメント優先"}', 'B', 'SINGLE_CHOICE'),
('a1b2c3d4-0000-4000-8000-000000000815', '660e8400-e29b-41d4-a716-446655440022', '単体テストの対象として正しいものは？', '{"A": "システム全体", "B": "個々のモジュール", "C": "ユーザーインターフェース", "D": "データベース全体"}', 'B', 'SINGLE_CHOICE'),
('a1b2c3d4-0000-4000-8000-000000000816', '660e8400-e29b-41d4-a716-446655440022', '結合テストの目的として正しいものは？', '{"A": "個々の機能の検証", "B": "モジュール間の連携確認", "C": "性能測定", "D": "セキュリティ評価"}', 'B', 'SINGLE_CHOICE'),
('a1b2c3d4-0000-4000-8000-000000000817', '660e8400-e29b-41d4-a716-446655440022', 'CI/CDの「CI」は何を意味するか？', '{"A": "Continuous Integration", "B": "Computer Intelligence", "C": "Code Improvement", "D": "Complete Installation"}', 'A', 'SINGLE_CHOICE'),
('a1b2c3d4-0000-4000-8000-000000000818', '660e8400-e29b-41d4-a716-446655440022', 'スクラム開発における「スプリント」とは？', '{"A": "プロジェクト全体の期間", "B": "短期間の開発サイクル", "C": "要件定義の手法", "D": "テストの種類"}', 'B', 'SINGLE_CHOICE'),
...
-- Chapter 9: Loops
INSERT INTO questions (id, chapter_id, question_text, options, correct_answer, question_type) VALUES
('a1b2c3d4-0000-4000-8000-000000001001', '660e8400-e29b-41d4-a716-446655440019', 'for文の基本構文として正しいものは？', '{"A": "for (初期化; 条件判定; 更新)", "B": "for (条件判定; 初期化; 更新)", "C": "for (初期化; 更新; 条件判定)", "D": "for (条件判定)"}', 'A', 'SINGLE_CHOICE'),
...
('a1b2c3d4-0000-4000-8000-000000001005', '660e8400-e29b-41d4-a716-446655440019', 'ループ内で残りの処理を飛ばして次の繰り返しに進むためのキーワードは？', '{"A": "skip", "B": "continue", "C": "next", "D": "pass"}', 'B', 'SINGLE_CHOICE'),
...
('a1b2c3d4-0000-4000-8000-000000001008', '660e8400-e29b-41d4-a716-446655440019', 'for文で i=0; i<5; i++ の場合、ループは何回実行される？', '{"A": "4回", "B": "5回", "C": "6回", "D": "0回"}', 'B', 'SINGLE_CHOICE'),
...
('a1b2c3d4-0000-4000-8000-000000001204', '660e8400-e29b-41d4-a716-446655440021', 'メソッドを呼び出す際に、実際に渡す値は何と呼ばれる？', '{"A": "パラメータ", "B": "引数", "C": "戻り値", "D": "例外"}', 'B', 'SINGLE_CHOICE'),
...
('a1b2c3d4-0000-4000-8000-000000001208', '660e8400-e29b-41d4-a716-446655440021', 'メソッドの引数として渡した変数の値を、メソッド内で変更した場合、呼び出し元の変数の値も必ず変わる？', '{"A": "常に正しい", "B": "常に誤り", "C": "プリミティブは変わらず参照は変わることがある", "D": "Stringだけ変わる"}', 'C', 'SINGLE_CHOICE'),
