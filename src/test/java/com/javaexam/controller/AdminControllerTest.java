...
class AdminControllerTest {
        ...
        void importQuestionsCsv_shouldRedirectToQuestionsPage_whenSuccess() throws Exception {
                MockMultipartFile file = createQuestionsCsvFile();

                mockMvc.perform(multipart("/admin/import/csv/questions").file(file).with(csrf()))
        ...
        @Test
        @WithMockUser(roles = "ADMIN")
        void importQuestionsCsv_shouldSetErrorMessage_whenIOException() throws Exception {
                MockMultipartFile file = createQuestionsCsvFile();
        ...
        @Test
        @WithMockUser(roles = "ADMIN")
        void importQuestionsCsv_shouldSetErrorMessage_whenUnexpectedException() throws Exception {
                MockMultipartFile file = createQuestionsCsvFile();
